				...
				<div class="row">
					<div class="collection-wrapper">
						<h1 class="collection-title">
							<span>
								<a href="./namecard.do" title="All Products">줄/이름표</a>
							</span>
						</h1>
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href="./namecard.do" title="줄/이름표" itemprop="url"><span itemprop="title">줄/이름표</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/Accessory/Lead/0101.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">쏘아베 레오파드 가슴줄 130cm</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;"> 120원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩14,000" data-currency="KRW">12,000원</span></h2>
													</div>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>미국 텍사스 출신의 전문 십자수 선생님께서 손수 제작하신 천연 면 100% 애견 목줄입니다. 길이가 기존 제품보다 10cm 이상 더 길어서 줄을 놓치셔도 금방 잡으실 수 있습니다. 쏘아베는 고객의 신뢰를 바탕으로 반려동물의 삶을 풍요롭고 즐겁게하는 애완용품 전문점입니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
