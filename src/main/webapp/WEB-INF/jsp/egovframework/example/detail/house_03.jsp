				...
				<div class="row">
					<div class="collection-wrapper">
						<h1 class="collection-title">
							<span>
								<a href="./house.do" title="All Products">하우스 / 울타리</a>
							</span>
						</h1>
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href="./house.do" title="하우스 / 울타리" itemprop="url"><span itemprop="title">하우스 / 울타리</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/house/house_03.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">푸르미 매직 울타리 팬스 아이보리 12p</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">20,500원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>푸르미 매직 울타리 팬스 12P는 내가 원하는 모양대로 만들어 애견에게 아늑하고 포근한 공간을 만들어 줄 수 있도록 제작된 제품입니다. 정사각형, 직사각형, 육각형 등 모양과 크기를 마음대로 조절할 수 있어 편리하게 사용할 수 있으며 고급스런 색상과 인체에 무해한 재료를 사용하여 애견에게 무해합니다. 일반 철장과는 달리 제품이 녹이 슬거나 도금이 벗겨지지 않아 장기간 사용이 가능하며 각각의 블록 형태에 곡선을 가미하여 인테리어적인 면에서 철장의 차가운 느낌보다 내츄럴한 자연스러운 분위기를 연출합니다. 또한, 설치가 쉬우며 상황에 따라 빠르고 편리하게 폈다 접었다 할 수 있어 보관이 간편하고, 끼움 고정 나사가 들어 있어 블록이 쉽게 빠지지 않고 견고합니다. 베란다가 있는 방의 코너 및 일반 거실의 공간 절약에 도움이 되며 2단 조립으로 더 높게 펜스를 설치하여 다양하게 사용할 수 있습니다. 반드시 부드러운 천으로 닦아주십시오. 제작 과정의 원료 특성상 이미지와 실제품은 다소 연하거나 진한 색상톤 차이가 있을 수 있습니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
