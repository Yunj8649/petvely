				...
				<div class="row">
					<div class="collection-wrapper">
						<h1 class="collection-title">
							<span>
								<a href="./feed.do" title="All Products">급수기 / 급식기</a>
							</span>
						</h1>
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href="./feed.do" title="급수기 / 급식기" itemprop="url"><span itemprop="title">급수기 / 급식기</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/feed/feed_02.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">버디즈 사료통 2.4kg</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">11,000원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>버디즈 사료통은 새로 구입한 신선한 사료를 포장 그대로 컨테이너에 넣어 매일 매일 원래 사료의 신선함 그대로 사랑스러운 반려동물에게 제공할 수 있도록 만들어진 제품입니다. 2면결착 밀폐형으로 냄새에 대한 걱정이 없고 슬립한 바디로 좁은 공간에 보관이 용이하며 원터치로 한번에 열 수 있어 사용이 편리합니다. 많은 양의 사료가 들어있어도 견고하게 제작된 컨테이너의 손잡이로 편리하게 사료를 급여할 수 있으며 미국의 특허받은 기술로 제작된 캡은 내용물의 신선함을 유지 할 수 있도록 잘 밀착되어 있습니다. 컨테이너 캡을 통하여 원하는 양의 사료를 조절하여 급여할 수 있으며 두가지 방식으로 급여 가능한 플립 뚜껑이 있어 대용량, 소용량 두가지 방식으로 쉽게 사료를 급여할 수 있습니다. 강한 충격을 주거나 화기 옆에 보관하는 것은 제품의 변형 및 파손을 일으킬 수 있으며 완전 밀폐가 아니므로 액체 내용물 보관시 눕히거나 흔들지 마십시오. 본 제품의 용량은 일반적인 사료양을 기준으로 최대 2.4kg가량 저장가능하며, 사료의 크기나 입자에 따라 오차범위가 있을 수 있으니 이점 참고 부탁드립니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
