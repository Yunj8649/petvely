				...
				<div class="row">
					<div class="collection-wrapper">
						<h1 class="collection-title">
							<span>
								<a href="./supplements.do" title="All Products">영양제</a>
							</span>
						</h1>
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href="./supplements.do" title="영양제" itemprop="url"><span itemprop="title">영양제</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/supplements/supplements_2.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">In 인 반려견의 피부병 및 면역 강화제 680g x 2개 세트</h1>
											<form id="add-item-form" action="./cart.html" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;">5,400원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money">54,720원</span></h2>
													</div> 
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<img src="./assets/images/supplements/detail/supplements_2_detail.jpg" alt="">
													<p>☞ 등록성분</p><br>
													<p>조단백질: 17.0%, 조지방: 27.0%, 조섬유: 2.5%, 조회분: 12%, 수분: 8.0%</p><br>
													<p>1pound 당 제공영양소</p><br>
													<p>칼슘: 1.20%, 인: 1.00%, 비타민A: 26,000IU, 비타민D: 2,600IU, 비타민E: 425IU, 비타민B1: 3.2mg, Riboflavin: 1.5mg, Niacin: 12.80mg, Choline: 5,200mg</p><br>
													<p></p><br>
													<p>☞ 사용원료</p><br>
													<p>soybean lecithin, defatted wheat germ flour, whole grain brown rice, corn meal, raw wheat germ, chicken, soy protein concentrate, soy flour, chicken fat (preserved with mixed tocopherols, a source of vitamin E) , flaxseed , cod liver oil, powdered cane molasses, glycerine , choline chloride, calcium pantothenate, ferrous sulfate, zinc sulfate, salt. vitamin supplements: riboflavin ,A, D3, E, B1, B12</p><br>
													<p></p><br>
													<p>☞ 제품규격</p><br>
													<p>680g/너겟 312개</p><br>
													<p></p><br>
													<p>* 유통기한 읽는 법</p><br>
													<p>제품 하단 바닥면에 월/일/년의 순서로 기재되어 있습니다. MFG는 제조일자를, EXP는 유통기한을 의미합니다.</p><br>
													<p></p><br>
												</div>
											</div>
										</div>
