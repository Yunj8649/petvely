										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/Accessory/Wear/0201.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">G마켓 애견 스카프 목줄 강아지 패션 악세사리</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;"> 25원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩2500" data-currency="KRW">2500원</span></h2>
													</div>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>완전 사랑스럽고 귀여운 손수건 같이 생긴 스카프입니다. 완전 귀염 돋죠? 라는 이야기를 주변에서 많이 듣게 되실겁니다. 어쩔수 없습니다. 저희 제품을 선택하시는 순간 귀염은 장착하게 되는겁니다. </p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
