										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/clean/clean_01.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">부들부들 클린 탈취제 베이비파우더 향 530ml</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">3,800원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>부들부들 유기농 그린티 탈취제는 프랑스 에코서트에서 인증받은 유기농 천연 녹차 추출물이 함유하여 저자극, 저독성으로 전혀 해가 되지 않고, 편백수에서 나오는 피톤치드가 함유되어 애완동물의 고유의 냄새나 그 주위에 배인 냄새를 탈취, 향균 및 소독하는 제품입니다. 세신, 백지, 감국, 피톤치드 함유로 애견의 피부 건강을 생각하였습니다. 애완동물의 집 주변 및 배설물 장소 등에 분무하여 건조시킵니다. 붉은반점, 부어오름, 가려움증, 자극이 있을시 사용을 중지하시기 바랍니다. 상처가 있는 곳 또는 습진 및 피부염 등의 이상이 있는 부위에는 사용하지 마시기 바랍니다. 눈에 들어 갔을 때에는 즉시 씻어 주시기 바랍니다. 사용후 마개를 닫고 유, 소아의 손이 닿지 않는 곳에 보관 바랍니다. 고온 내지 저온의 장소 및 직사광선이 닿는 곳에 보관하지 마시기 바랍니다. 액체 특성상 온도 및 기후등이 상품과 배송에 영향을 줄 수 있어, 계절에 따라 포장이 변경될수 있으니 구매시 참고해주십시오. </p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
