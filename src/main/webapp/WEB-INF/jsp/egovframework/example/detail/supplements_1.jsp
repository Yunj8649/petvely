										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/supplements/supplements_1.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">8in1 엑셀 브루어 이스트 140정</h1>
											<form id="add-item-form" action="./cart.html" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;">750원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money">7,650원</span></h2>
													</div> 
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<img src="./assets/images/supplements/detail/supplements_1_detail.jpg" alt="">
													<p>* 원재료</p><br>
													<p>Debittered Brewer's Dried Yeast, Glycerin, Stearic Acid, Dehydrated Garlic, Safflower Oil, Fish Oil, Ferrous Carbonate, Zinc Oxide, Niacin, Manganese Sulfate, Riboflavin, Thiamine Hydrochloride, Copper Sulfate, Cobalt Carbonate, Pyridoxine Hydrochloride, Biotin</p><br>
													<p></p><br>
													<p>* 등록성분(1정당)</p><br>
													<p>조단백질 36%, 조지방 0.1%, 조섬유 10%, 수분 10%</p><br>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
