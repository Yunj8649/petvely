										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/walk/walk_04.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">아이리스 폴딩 캐리어 블랙 20kg 이하</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">95,000원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>아이리스 폴딩 캐리어는 오렌지색 포인트로 세련된 배색이 돋보이는 이동가방입니다. 장거리 이동 시나 집에서 하우스로 이용할 수 있도록 견고하게 제작되었고 문을 제거하면 실내에서는 하우스로 사용이 가능합니다. 문은 선재로 되어 있어 무는 습관이 있는 애견에게도 안심하고 사용할 수 있으며, 중, 대형견용에게 알맞는 사이즈로 소형견인 경우 2마리까지 들어갈 수 있습니다. 보관할 때에는 15cm 이하로 납작하게 접히기 때문에 공간을 절약할 수 있습니다. IATA 국제 화물 수송 협회의 기준을 통과한 제품으로 비행기 수송용 이동장으로 최적의 제품이며 자체 중량은 7.3kg이고 20kg이하의 애견까지만 탑승 가능합니다. 세척시에는 반드시 부드러운 천으로 닦아 주십시오. 완제품 박스포장으로 배송되는 상품 특성상 교환,반품이 불가하니 구매에 유의해주십시오.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
