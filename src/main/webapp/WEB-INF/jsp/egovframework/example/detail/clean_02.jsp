										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/clean/clean_02.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">요요쉬 패드 소형 플로랄와인 50매</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">7,700원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>요요쉬 패드 플로랄와인 50매는 천연펄프의 고강도 압축으로 먼지가 발생하지 않습니다. Sap(고분자 흡수체) 과학적 엠보싱으로 소변을 신속하게 흡수하고, 청결을 유지 합니다. 국내 최초로 애견전용 패드 자율 안전 확인 인증을 획득 하였으며 유한 킴벌리의 최고급 부직포 원단을 사용하여 안심하고 사용하실 수 있으며, 패드 뒷면 엠보 방수지를 사용하여 미끄럼 방지와 로고를 인쇄하여 고급화를 추구하였습니다. 또한, 패드자체에 은은한 향을 첨가하여 살균과 방향제 기능을 추가하여 고양이의 소변으로 인한 냄새를 신속하고 빠르게 탈취 합니다. 패드는 여름, 혹은 겨울이 지나면 습도에 의해 사용이 불가능한 경우가 생길 수 있으니 개봉 후 6개월 안에 사용하시는 것을 권장 드립니다. 애견이 소변을 볼 수 있는 장소에 패드를 깔아주고 배변 조짐이 보이면 패드로 데려가 줍니다. 다른 장소에 배변하면 혼내주시고 그 자리를 냄새가 나지 않도록 잘 닦아 주시어 다시 실수를 하지 않게 해주고 정상적으로 패드를 사용하면 칭찬을 해줍니다. 수차례 반복 지도하면 약 1주일 내에 패드 사용에 적응하게 됩니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
