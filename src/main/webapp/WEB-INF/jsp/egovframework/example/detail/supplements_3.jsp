						...
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href="./supplements.do" title="목욕용품" itemprop="url"><span itemprop="title">영양제</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/supplements/supplements_3.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">더마펫 에피트릿 226.8g</h1>
											<form id="add-item-form" action="./cart.html" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;">1,800원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money">18,000원</span></h2>
													</div> 
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<img src="./assets/images/supplements/detail/supplements_3_detail.jpg" alt="">
													<p>☞ 제품명 </p><br>
													<p>EpiTreat 에피트릿</p><br>
													<p></p><br>
													<p>☞ 원료 </p><br>
													<p>건조감자, 닭간, 정제수, 옥수수시럽, 글리세린, 계유, 탄산칼슘, 레시틴, 염화칼륨, 인산, 소금, 소르빈산, 로즈마리추출물</p><br>
													<p></p><br>
													<p>☞ 등록성분 </p><br>
													<p>조단백질: 11.0% 이상</p><br>
													<p>조지방: 5.0% 이상</p><br>
													...
													<p></p><br>
													<p>☞ 주의사항 </p><br>
													<p>1. 직사광선을 피해 습기가 없고, 시원한 곳에 보관하십시오</p><br>
													<p>2. 개봉 후 빨리 사용하시기 바랍니다</p><br>
													<p>3. 반추동물에게는 급여하지 마십시오</p><br>
													<p>4. 위 사용원료는 공장 사정에 따라 배합비율이 변경 될 수 있습니다</p><br>
													<p>5. 유전자변형 원료를 포함할 가능성이 있습니다</p><br>
													<p></p><br>
													<p>☞ 유통기한 </p><br>
													<p>제품 후면에 별도 표기 (제조일은 유통기한으로부터 24개월 전)</p><br>
													<p></p><br>
													<p>☞ 제조원 및 원산지 </p><br>
													<p>Dechra Veterinary Products A/S 미국</p><br>
													<p></p><br>
												</div>
											</div>
										</div>
