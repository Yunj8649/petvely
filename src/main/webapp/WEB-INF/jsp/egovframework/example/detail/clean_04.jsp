										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/clean/clean_04.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">푸르미 그물망 토일렛 발판 그린</h1>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>푸르미 토일렛은 아가들의 보송보송한 발 관리를 위한 아이디어 제품으로서 기존의 그물망토일렛의 단점인 위 그물망이 쉽게 분리되는 것을 보완하여 아가들이 안에 있는 패드나 신문지를 쉽게 뺄 수 없습니다. 그물망 양쪽 손잡이가 “딸각” 소리가 나도록 눌러 놓으시면 완전히 아래 판에 밀착되며, 그물망 중앙부분에는 제품을 튼튼하게 해주기 위해 십자방향으로 더 두껍게 보완 제작한 제품입니다. 윗판을 분리한 후 그 안에 패드 또는 신문지를 아랫판에 깔아서 사용해주시고, 소변량이 작은 아가들의 경우 매번 패드를 깔아주지 않고 그냥 패드 없이 사용하시다가 배변판만 물로 헹궈내셔도 됩니다. 아랫판 바닥에는 고무 패킹이 부착되어 있어 아가들이 밀어도 쉽게 움직이지 않으며, 강아지가 윗판에 대변을 봤을 시는 간단히 윗판의 대변만 버려주면 됩니다. 세척 시에는 솔로 가볍게 씻어주시면 됩니다. 제작 과정의 원료 특성상 이미지와 실제품은 다소 연하거나 진한 색상톤 차이가 있을 수 있습니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
