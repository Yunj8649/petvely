				...
				<div class="row">
					<div class="collection-wrapper">
						<h1 class="collection-title">
							<span>
								<a href="./dogFood.do" title="All Products">사료</a>
							</span>
						</h1>
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href="./dogFood.do" title="사료" itemprop="url"><span itemprop="title">사료</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/Food/DogFood/dogFood (2).png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">[라일리스] 오가닉 L 3개 + S 1개 (set)</h1>
													...
													<table id="point_deli">
														<tbody>
															...
															<tr height="">
																...
																<td>0원 (3만원 이상구매시 무료)</td>
															</tr>			
														</tbody>
													</table>
													<div class="product-price"> <!-- @김병직 가격 -->
														<meta itemprop="price" content="32,000">
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩32,000" data-currency="KRW">32,000원</span>
														<del class="price_compare"> <span class="money">38,000원</span></del></h2>
													</div>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<img src="./assets/images/Food/DogFood/dogFood_detail/dogFood1_detail.jpg" alt="">
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
