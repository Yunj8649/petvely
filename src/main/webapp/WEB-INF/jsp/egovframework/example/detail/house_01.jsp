										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/house/house_01.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">요기 개벽 안전문 소형견용</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">9,000원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>요기 개벽 안전문 소형견용은 주방, 현관, 방, 베란다 등 애견의 출입을 제한하고자 하는 공간에 설치하는 제품입니다. 플라스틱 반투명 판재로 만들어져 있으며 벨크로를 이용하여 쉽게 뗐다 붙였다 하실 수 있어 편리합니다. 제품의 접이면이 모두 접혔다 펴지기 떄문에 좁은 공간에서 폭 1m까지 설치가 가능하며 여러 개를 연장하여 길게 사용할 수도 있습니다. 또는, 애견의 안전을 위해 테두리를 천으로 마감하였으며, 중형견 이상 큰 애견은 뛰어넘을 수 있습니다. 양면 테이프로 붙이기 때문에 제거시 벽지 등에 손상이 생길 수 있으니 반드시 부드러운 천으로 닦아주시고, 제거가 필요한 경우 스티커 제거제를 사용바랍니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
