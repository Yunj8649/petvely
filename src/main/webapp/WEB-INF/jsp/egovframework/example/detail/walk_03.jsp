										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/walk/walk_03.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">닥터펫 패션 이동가방 핑크</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">1,900원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>닥터펫 패션 이동가방은 견고한 재질이 돋보이며, 국내에서 제조하여  마무리가 깔끔한 이동가방입니다. 튼튼한 손잡이와 어깨끈으로 오랜 이동시간에도 손이나 어깨가 아프지 않도록 보호해주며, 애견을 안정감 있게 이동시킬 수 있습니다. 양쪽 측면에는 작은 소품을 넣을 수 있는 수납공간과 망사처리한 통풍구가 있어 여름에는 시원하게, 겨울 에는 따뜻하게 4계절 이용이 가능하고, 정면에는 3개의 통풍구가 밝고 환기를 시켜주어 애견에게 답답함을 주지 않으며, 내부는 바닥심이 따로 있어 애견을 단단하게 받쳐주고, 목줄에 연결할 수 있는 안전줄은 애견이 이동가방 밖으로 나가는 것을 방지해 줍니다. 가방 바닥에는 손상 방지용 다리가 부착되어 있어 어느 곳에 놔둬도 가방을 흔들림 없이 안전하게 보호해 주고, 파우치가 따로 있어 필요한 물품을 담아서 다닐 수 있어서 편리하며, 지퍼로 쉽고 간편하게 조립할 수 있어 사용하지 않을 때에는 분리하여 보관하면 공간을 절약할 수 있습니다. 스트랩 최단길이는 70cm, 최장길이는 110cm이고, 어린 강아지부터 최대 7kg의 애견까지 사용 가능합니다. 생산공정상 염색단계에서 가방 안쪽에 검정 잉크가 약간 튈수 있습니다. 안감이라 외관에 노출되지 않으며, 애견에게 전혀 해가 없습니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
