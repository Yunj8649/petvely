										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/Accessory/Training/0005.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">원형 치실 타래 8cm</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;"> 50원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩5000" data-currency="KRW">5000원</span></h2>
													</div>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>원형 치실 타래, 볼형태 장난감. 치실 토이. 원형 실타래. 실타래를 좋아하는 아이들을 위해서 공모양으로 만든 치실공 장난감입니다. 3~4가지 색상의 실타래가 예쁘게 꼬아져 있습니다. 견고하게 엮인 실타래 공을 물고 놀면서 치석제거 및 스트레스 해소에 도움이 됩니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
