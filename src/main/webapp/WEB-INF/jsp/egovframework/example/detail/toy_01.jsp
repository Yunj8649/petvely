				...
				<div class="row">
					<div class="collection-wrapper">
						<h1 class="collection-title">
							<span>
								<a href="./toy.do" title="All Products">장난감/훈련용품</a>
							</span>
						</h1>
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href=".toy.do" title="장난감/훈련용품" itemprop="url"><span itemprop="title">장난감/훈련용품</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/Accessory/Training/0002.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">도그포즈 아령장난감 10cm</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;"> 10원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩990" data-currency="KRW">990원</span></h2>
													</div>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>도그포즈 아령장난감 소형 입니다. 고무로 되어있으며 누르면 삑삑 소리가 납니다. 물어뜯기 좋아하는 강아지들의 습성을 이용해서 놀이를 하면서 입냄새 제거 및 치석 제거 효과를 보실 수 있습니다. 강아지들의 지능발달에 도움이 됩니다. 던져서 물어오기 할때도 유용하게 사용됩니다. 강아지들이 좋아하는 향기가 납니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
