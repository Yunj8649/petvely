										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/house/house_02.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">요기펫 견문 베란다용</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">18,000원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>요기 견문 베란다용은 베란다에 용변을 보는 애견을 위해 제작된 제품으로 여름 밤 에어컨 찬바람이 새어나가고, 겨울 밤 차가운 바람이 들어오는 것을 막아 줍니다. 벨크로 테입으로 붙이기 때문에 설치와 해체가 용이합니다. 편리한 사용을 위해 베란다샷시 뒷면에 부착하시면 좋고, 부착 전엔 뒷면에 제품을 대어보고 설치 해주세요. 반드시 부드러운 천으로 닦아주시기 바랍니다. 출입문 사이즈는 200*270cm 입니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
