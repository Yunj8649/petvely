										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/supplements/supplements_4.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">도그데이즈 프리락토스 천연 유산균 분말타입 60g</h1>
											<form id="add-item-form" action="./cart.html" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;">1,000원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money">10,000원</span></h2>
													</div> 
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<img src="./assets/images/supplements/detail/supplements_4_detail.jpg" alt="">
													<p style="font-size:20px;font-weight:bold;">제품 규격 및 기타 설명</p><br>
													<img src="./assets/images/supplements/detail/supplements_4_1_detail.jpg" alt="">
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
