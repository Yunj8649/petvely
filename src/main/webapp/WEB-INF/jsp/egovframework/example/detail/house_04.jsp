										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/house/house_04.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">육각 운동장 대</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">29,800원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>육각 운동장은 간섭받지 않고 일을 해야 할 때, 다른 가족들에게 피해를 줄 때 필요한 운동장입니다. 철제로 견고하게 만들어져 부식으로 인한 수명도가 다른 철장에 비해 오래가며, 쉽게 조립할 수 있어 이동에도 편리합니다. 밖에 나가면서도 어디 나가거나 지저분하게 해 놓을까봐 안심이 안되시는 분께 좋으며, 설치 후 지름은 140cm로 답답한 집안에서 뛰어 놀 수 있는 공간을 마련해 주는 제품입니다. 반드시 부드러운 천으로 닦아주세요. 완제품 박스입고되는 상품으로 제품 특성상 교환, 반품이 불가능하오니 이점 참고부탁드립니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
