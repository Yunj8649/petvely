										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/walk/walk_01.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">리첼 캠핑캐리 싱글도어 브라운</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">39,200원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>리첼 캠핑캐리 싱글도어는 조립식으로 밖에서는 캐리어로 실내에서는 하우스로 가능한 2way 제품입니다. 안전밸트 고정 기능으로 차량용으로도 사용가능하며, 원터치로 문의 탈부착이 가능하므로 하우스로도 적합합니다. 사용하지 않을 때에는 본체의 상부와 하부를 겹쳐서 버클로 고정시킬 수 있어 깔끔한 수납이 가능합니다. 평소에도 하우스로 사용하여 적응시키면 외출이나 재난 시 거부감 없이 무난히 이동 가능합니다. 물기가 많이 닿지 않도록 닦아주시고 빠른 건조해 주세요. S사이즈 중량은 1.5kg이며, 체중기준은 5kg 이하 입니다. M사이즈 중량은 2kg이며, 체중기준은 8kg 이하입니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
