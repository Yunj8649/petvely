										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/feed/feed_04.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">수퍼펫 플랫 더블 보울</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩999,999" data-currency="KRW">17,900원</span></h2>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>수퍼펫 플랫 더블 보울은 멜라민 소재로 만들어져 일반 플라스틱과는 달리 내열 내구성이 강하며 잘 깨지지 않고 유해물질이 거의 없습니다. 바닥면은 고무패킹이 되어 있어서 식기가 밀리거나 미끄러지지 않습니다. 원목에서 느껴지는 내추럴한 느낌의 나무결 무늬로 코팅되어 원목과 같은 느낌으로 사용하실 수 있습니다. 깔끔한 식기 사용을 위해 세척시 식기가 분리되어 위생적으로 사용하실 수 있습니다. 식탁 양쪽 사이트에는 손잡이 홈이 있어서 식탁 이동시 편리합니다. 스크레치를 유발시킬수 있는 세척재료나 수세미를 사용하지 마세요. 제품을 고열에 노출시킬 경우 변색이 되거나 손상될 수 있으며 무리한 충격은 파손이나 고장의 원인이 될 수 있으니 주의해 주세요.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
