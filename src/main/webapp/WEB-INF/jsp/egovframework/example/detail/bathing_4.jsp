				...
				<div class="row">
					<div class="collection-wrapper">
						<h1 class="collection-title">
							<span>
								<a href="./bathing.do" title="All Products">목용용품</a>
							</span>
						</h1>
						<div class="breadcrumb-group">
							<div class="breadcrumb clearfix">
								...
								<span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
									<a href="./bathing.do" title="목욕용품" itemprop="url"><span itemprop="title">목욕용품</span></a>
								</span>
								<span class="arrow-space">></span>
								<strong>상품</strong>
							</div>
										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/bathing/bathing_4.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">yuup 윱 화이트닝 샴푸 1000ml</h1>
											<form id="add-item-form" action="./cart.html" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;"> 3,500원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money">35,000원</span></h2>
													</div> 
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<img src="./assets/images/bathing/detail/bathing_4_detail.jpg" alt="">
													<p>▶원산지</p><br>
													<p>- 이태리 </p><br>
													<p></p><br>
													<p>▶제품특징</p><br>
													<p>- 아마인씨, 천연대나무추출물 함유</p><br>
													<p>- 흰색, 밝은색 모발은 더욱 선명하게 해줌</p><br>
													<p>- 탈색, 손상모는 윤기나는 밝은 색상으로 회복</p><br>
													<p></p><br>
													<p>▶사용법</p><br>
													<p>피모를 충분히 적신 뒤 샴푸한 후 깨끗한 물로 씻어 주십시오.</p><br>
													<p></p><br>
												</div>
											</div>
										</div>
