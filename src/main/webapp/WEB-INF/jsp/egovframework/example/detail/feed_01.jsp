										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/feed/feed_01.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">엠보싱 스텐식기</h1>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>엠보싱 스텐식기는 세척이 간편하고 깨지지않아 내구성이 뛰어난 스테인레스 재질로 만든 위생적인 도그볼 식기 제품입니다. 아기자기한 엠보싱 무늬로 인테리어 효과가 뛰어나며, 바닥 부분의 고무 재질 마감으로 급여시에 미끄러지지 않습니다.</p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
