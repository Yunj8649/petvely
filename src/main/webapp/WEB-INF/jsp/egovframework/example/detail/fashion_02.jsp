										...
										<div class="col-md-5" id="product-image">
											...
											<div id="featuted-image" class="image featured">
													<div class="image-item">
														<img src="./assets/images/Accessory/Wear/0202.png" alt="" data-item="1">
													</div>
												</div>
										</div>
										<div class="col-md-7" id="product-information">
											<h1 itemprop="name" class="title">퍼피장 아씨배자 강아지 한복 애견 한복</h1>
											<form id="add-item-form" action="./cart.do" method="post" class="variants">
												<div class="product-options " itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
													...
													<table id="point_deli">
														<tbody>
															<tr>	
																...
																<td><img src="./assets/images/icon_point.jpg" style = "padding-right: 10px;"> 315원</td>
															</tr>	
															<tr height="">
													...
													<div class="product-price"> <!-- @김병직 가격 -->
														...
														<h2 class="price" id="price-preview"><span class="money" data-currency-krw="₩31500" data-currency="KRW">31500원</span></h2>
													</div>
										...
										<div class="information_content panel panel-default">
											...
											<div id="collapse_des" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_des">
												<div class="panel-body">
													<p>귀엽고, 시원하고, 앙증맞고, 우아한 강쥐옷이 많은 퍼피짱 , 예쁜 디자인과 귀엽고 앙증맞은 디자인, 우아하고 럭셔리한 옷들. 명절에 더욱 잘 어울려요. 한복을 포함하여 다양하고 독특한 강아지 옷들이 많습니다. </p>
												</div>
											</div>
										</div>
										<div class="information_content panel panel-default">
