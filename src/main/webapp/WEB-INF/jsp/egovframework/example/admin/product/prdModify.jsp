...
$(document).ready(function(){
	...
	$("#modify_btn").click(function () {
		...
		if (!prNm) {
			...
			return false;
		} else if (CommonJsUtil.isEmpty(prImg1)) {
			...
			$create_prd.attr("action", "product_update.do");
				...
				<form name="insertPRD" id="insertPRD" accept-charset="UTF-8" 
					...
					<table width="75%" border="1" cellspacing="1" cellpadding="1">
						<tr>
							...
							<td><input type="text" value="${productList[0].prNm}" name="prNm" id="prNm" class="text" size="30"></td>
						</tr>
						<tr>
							<td>브랜드명&nbsp;<label id="required">*</label></td>
							<td><input type="text" value="${productList[0].brdNm}" name="brdNm" id="brdNm" class="text" size="30"></td>
						</tr>
						<tr>
						...
						<tr>
							<td>색상</td>
							<td><input type="text" value="${productList[0].prClr}" name="prClr" id="prClr" class="text" size="30"></td>
						</tr>
						<tr>
							<td>옵션&nbsp;(크기,용량,길이)</td>
							<td>
                            	<input type="text" value="${productList[0].prOpt}" name="prOpt" id="prOpt" class="text" size="30">
                            </td>
                        <tr>
                            <td>상품 가격&nbsp;<label id="required">*</label></td>
							<td><input type="text" value="${productList[0].prPrc}" name="prPrc" id="prPrc" class="text" size="30"> </td>
						</tr>
<!-- 								<tr> -->
<!-- 									<td>시작일</td> -->
...
<!-- 								</tr> -->
						<tr>
							...
							<td><input type="text" value="${productList[0].prCntSto}" name="prCntSto" id="prCntSto"></td>
						</tr>
						<tr>
							<td>대표 이미지</td>
							<td>	
								<input type="file" value="${productList[0].prImg1}" name="prImg1" id="prImg1">
						...
						<tr>
							<td>상세 이미지</td>
							<td>
								<input type="file" value="${productList[0].prImg2}" name="prImg2" id="prImg2">
								<img id="imgfileDetail" width="200" height="200" />
							</td>
						</tr>
						<tr>
							<td>상세 설명</td>
							<td><input type="text" value="${productList[0].prDes1}" name="prDes1" id="prDes1"></td>
						</tr>
						<tr>
							<td>간략 설명&nbsp;<label id="required">*</label></td>
							<td><input type="text" value="${productList[0].prDes2}" name="prDes2" id="prDes2"></td>
						</tr>
					</table>
					<div class="action_bottom">
						<input class="btn" type="submit" value="상품 수정" id="modify_btn">
					</div>
				</form>
			</div>
		</div>
