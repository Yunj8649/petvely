					...
					<tbody>
						<tr>
							...
							<td>
								...
								<pre style="text-align: left; border: none; background-color: white;"><c:out value="${noticeDetailList[0].ntCtt}"/>
								</pre>
							</td>
						</tr>
					</tbody>
				</table>
				<a class="btn btn-default pull-right" id="close_btn" href=""> 닫기 </a>
			</div>
		</div>
	</main>
</div>