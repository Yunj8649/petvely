...
function handleScrollTop() {
    ...
    function totop_button(a) {
        ...
        if (a == "on") {
            ...
            down.addClass("on fadeInRight ").removeClass("off fadeOutRight");
            b.addClass("on fadeInRight ").removeClass("off fadeOutRight");
        } else {
            f.addClass("off fadeOutRight animated").removeClass("on fadeInRight");
            down.addClass("off fadeOutRight animated").removeClass("on fadeInRight");
    ...
    $(document.body).on('click', '#scroll-to-bottom', function(e) {
        $target.animate({
